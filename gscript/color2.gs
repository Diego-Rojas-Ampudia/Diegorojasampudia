...
*** define rgb value
  ...
  if( color = 'deepskyblue')  ; r=0 ; g=191 ; b=255 ; a=210; endif
  ...
  if( color = 'royalblue')  ; r=65 ; g=105 ; b=225 ; a=210; endif
  ...
  if( color = 'darkviolet')  ; r=148 ; g=0 ; b=211 ; a=210; endif
  ...
  if( color = 'plum')  ; r=221 ; g=160 ; b=221 ; a=210; endif
  ...
  if( color = 'white')  ; r=255 ; g=255 ; b=255 ; a=0; endif
